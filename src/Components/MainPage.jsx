    ...
    <div>
        <div className="grid grid-cols-2 mx-auto gap-4 bg-slate-900 text-white h-96  ">
            <div className='border-r'>
                <h2>Player</h2>
                <div>
                    <div className='flex p-3'>Player Name :</div>
                    <div class="flex p-3 ">Base Price :  
                        <div class="flex items-center mr-4 ml-2">
                            ...
                            <label for="inline-radio" class="ml-2 text-sm font-medium   dark:text-gray-300">Inline 1</label>
                        </div>
                        <div class="flex items-center mr-4">
                            ...
                            <label for="inline-2-radio" class="ml-2 text-sm font-medium   dark:text-gray-300">Inline 2</label>
                        </div>
                        <div class="flex items-center mr-4">
                            ...
                            <label for="inline-checked-radio" class="ml-2 text-sm font-medium   dark:text-gray-300">Inline checked</label>
                        </div>
